...
public class HashSearchAdapter extends RecyclerView.Adapter<HashSearchAdapter.HashSearchViewHolder> {
    ...
    public HashSearchAdapter(List<MemeSearch.Data> mList, Context context) {
        this.mList = mList;
        this.context = context;
    }
    public HashSearchAdapter(List<MemeSearch.Data> mList, Context context, int mode) {
        this.mList = mList;
        this.context = context;
        this.mode = mode;
    }
    ...
    @NonNull
    @Override
    public HashSearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        if(mode == 0)
    ...
    @Override
    public void onBindViewHolder(@NonNull HashSearchViewHolder holder, int position) {
